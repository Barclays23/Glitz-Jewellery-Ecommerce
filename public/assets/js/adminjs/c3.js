...
var c3LineChart = c3.generate({
   ...
   data: {
   columns: [
      ['data1', 30, 200, 100, 40, 150, 250],
      ['data2', 50, 20, 10, 4, 15, 25]
   ]
   },
   color: {
...
setTimeout(function() {
   c3PieChart.load({
   columns: [
      ["Income", 20, 40, 30, 50, 70, 10, 80],
      ["Revenue", 25, 75, 60, 50, 89, 40, 23],
      ["Outcome", 14, 44, 67, 43, 67, 20, 77],
   ]
   });
}, 3500);
